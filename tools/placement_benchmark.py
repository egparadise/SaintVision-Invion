...
try:
    from tools.five_node_lab_preflight import (
        ...
        five_node_lab_dry_run,
        load_five_node_inventory,
        write_registration_mtls_preflight,
    )
except ModuleNotFoundError:  # Direct `python tools/placement_benchmark.py` execution.
    from five_node_lab_preflight import (  # type: ignore[no-redef]
        FIVE_NODE_FRESHNESS_SECONDS,
        FIVE_NODE_INVENTORY_SCHEMA_VERSION,
        FIVE_NODE_PROFILE,
        _FIVE_NODE_PREFLIGHT_SQL,
