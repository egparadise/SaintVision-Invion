...
async function runFullSmokeJourney() {
  ...
  try {
    ...
    try {
      if (typeof fs !== 'undefined' && fs.existsSync('scratch/desktop_ui_invariants.json')) {
        browserEvidence = JSON.parse(fs.readFileSync('scratch/desktop_ui_invariants.json', 'utf8'));
      }
    } catch {
