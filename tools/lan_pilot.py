...
def bundle(args):
    ...
    with zipfile.ZipFile(temporary,'w',zipfile.ZIP_DEFLATED) as archive:
        ...
        for name in ('prepare-worker.sh','start-node.sh','finish-worker.sh','Prepare-Worker.ps1','Start-Worker.ps1','worker_config.py','worker_storage.py','worker_replacement.py','repair-node.sh','Repair-Worker.ps1'):
