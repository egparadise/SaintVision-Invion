...
최종 사용자 회귀는 **1264 passed / 489 skipped / 2 deselected / 0 failed, 69초**다(tests/integration 제외·기본 not docker_host·DSN 없음). 1074 대비 +190이나 시험 증가분의 기원을 전수 대조하지 않아 감사 회귀로 귀속하지 않는다. PITR 제안·PITR 리허설·MJS-02·Evidence에서 수정된 코드 안에 같은 종류의 인접 false-green 또는 false-boundary가 남아 독립 검증에서 추가로 발견된 반복 구조도 감사 종합에 반영했다. 이를 작성자 개인의 부주의로 일반화하지 않고, 수정 범위를 원래 finding에 좁히기 쉬운 일반적 현상으로 기록한다.
