...
- PR #110 ancestry의 영구 postgres 시험은 disposable migration DB에 Node/channel/snapshot 5행을 시드하고 helper read-only·before/after 동일·serialized report tenant UUID/`tenantId`/full DSN 비출력·ready 5/겸임 1/독립 4를 단언한다. 실 PG 1 passed/8.76s, PG-free 16 passed다.
