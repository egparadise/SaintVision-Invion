...
???? inventory ?? ??(2026-09-19): `-a`? ????????????? ?? ???? ??? ??? ???? ????. ????? `ls -a`, ???????? `ls`? ????. ? ??? ?? ??? ?? format ??? ????, ?????? ??? `unverified`? ??? `--delete`??? ?? ????. ???? `-a` ??? ?? ? mismatch ????? ??? ?? ??? ??? ???? ?? ??. `.venv\Scripts\python.exe -m pytest -q tests/test_cleanup_owned_docker.py tests/test_vf_docker.py`: **10 passed**.

?? ?? ?? ???: container **53/53**, volume **85/85**, network **11/11**, `unverified=0`, `removed=0`. ?? ???(`saintvision-lan-db*`, `saintview-orthanc*`)? ????. ?? 53/84? ?? 53/85? ??? ????? ?? ??? ?? ?? ????, ??? ???? ???. ?? ??? ??? ?? ??? `--delete`? ???? ?? ???.
