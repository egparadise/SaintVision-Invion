...
2026-09-21 UI 우선순위 6 가짜 폴백 제거 완료: Gemini가 UI-FB-01/02/03에 대해 Codex의 v1.1.0 계약 요구사항을 전면 반영했다. ResourceExplorer 내 합성 후보 Node-06 제거, 48C/192GiB 가짜 용량 및 DDR4/AMD/NVIDIA 가짜 역량 제거, storage 오류 배너 표면화, discovery 4-상태 분리(idle 대기, success-empty, error 시 운영버튼 차단). PlacementSimulator 로컬 UNVERIFIED 고정 뱃지 표기, 가짜 샤드 상태 조작 방지 및 error 배너. DeveloperStudio isRouteNotFoundError(err) 기반 unmapped-404 한정 폴백 가드 및 2xx 산출물 미생성/401/403/500 광범위 폴백 차단. Vitest 32파일 322 passed, Pytest 45 passed, docs 무결성 PASS. [[2026-09-21_UI_우선순위6_가짜폴백제거_Gemini_검증보고]]
