...
> 충돌 시 [[최종 개발 계획 - 모든 개발의 지침]]과 [[설계 충돌 정정 및 ADR]]을 따릅니다. 이 문서는 원문 보존용이며 확정 구현 사양이 아닙니다. 원본은 Git `docs/sources/20_Architecture/Dev Workspace CLI Git Docker MLOps AI CLI 통합 설계.md`에 SHA-256과 함께 보존됩니다.
