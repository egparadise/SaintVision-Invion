...
try {
    ...
    @{success=$false;error=$_.Exception.Message;invoked=$global:svInvoked;arguments=$global:svCaptured} | ConvertTo-Json -Compress
}
""",
        encoding="utf-8",
    )
    result = subprocess.run(
        ...
        # PowerShell 7 module paths can hide Windows PowerShell 5 builtin modules.
    ...
    assert value["success"] is (fault in ("prepare", "apply")), value
